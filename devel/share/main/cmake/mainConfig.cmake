...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/cc/ee106a/fa15/class/ee106a-az/final_proj/src/main)
  set(main_DEVEL_PREFIX /home/cc/ee106a/fa15/class/ee106a-az/final_proj/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/cc/ee106a/fa15/class/ee106a-az/final_proj/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-bc <ee106a-bc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa15/class/ee106a-az/final_proj/src/main/${idir}'.  Ask the maintainer 'ee106a-bc <ee106a-bc@todo.todo>' to fix it.")
    endif()
